...
//TODO: Setable rules for handling duplicates, currently ignores duplicates
//TODO: fix issue in depricated block below
//TODO: a remove function
...
/*	DEPRECATED: Replace with the different traversal patterns as built in functions
		    rather than exposing data and having user implement it
...
*/
    ...
    bool contains(key k){
        return contains(tree, k);
    }

//TODO: Should function below be private/protected instead of public? (same thing in general with always needing the tree pointer
